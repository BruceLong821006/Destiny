...
{
    public class ManageController : Master
    {
        ...
        [HttpGet]
        public JsonResult LoadStroke(string key)
        {
            try
            {
        ...
        public JsonResult SaveStroke(Stroke stroke, string mode)
        {
            try
            {
                ...
                DBHelper db = new DBHelper();
                stroke.CreateBy = userInfo.UserName;
                stroke.CreateDate = DateTime.Now;
                if (mode.Equals("Edit"))
                    db.SaveStroke(stroke);
                else
                    db.AddStroke(stroke);
        ...
        public JsonResult AddStroke(Stroke stroke, string mode)
        {
            try
            {
                UserViewModel userInfo = (UserViewModel)Session["userInfo"];
